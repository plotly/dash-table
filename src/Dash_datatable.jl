...
"""
    ...
    Dash_datatable(children::Any;kwargs...)
    Dash_datatable(children_maker::Function;kwargs...)
...
function Dash_datatable(children::Any; kwargs...)
    result = Dash_datatable(;kwargs...)
    push!(result.props, :children => Front.to_dash(children))
    return result
end

Dash_datatable(children_maker::Function; kwargs...) = Dash_datatable(children_maker(); kwargs...)
