...
current tab, and _top opens the link in the top frame) or a string. markdown_options has the following type: lists containing elements 'link_target'.
Those elements have the following types:
...
that case.. tooltip has the following type: Dict with Strings as keys and values of type String | lists containing elements 'delay', 'duration', 'type', 'use_with', 'value'.
Those elements have the following types:
  - `delay` (Real; optional)
...
that case.. tooltip_header has the following type: Dict with Strings as keys and values of type String | lists containing elements 'delay', 'duration', 'type', 'value'.
Those elements have the following types:
  - `delay` (Real; optional)
  - `duration` (Real; optional)
  - `type` (a value equal to: 'text', 'markdown'; optional)
  - `value` (String; required) | Array of a value equal to: null | String | lists containing elements 'delay', 'duration', 'type', 'value'.
Those elements have the following types:
  - `delay` (Real; optional)
  - `duration` (Real; optional)
  - `type` (a value equal to: 'text', 'markdown'; optional)
