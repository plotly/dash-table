...
def html_table(df, base_column_style={},
               table_style={},
               column_style={},
               cell_style={},
    ...
    for i in range(len(df)):
        row = []
        for column in df.columns:
            row.append(html.Td(df.iloc[i][column], style=merge(
                cell_style, cell_style_by_column.get(column, {})
            )))
...
def layout():
    ...
    df_long = pd.DataFrame(OrderedDict([
        (name, col_data*10) for (name, col_data) in data.items()])
    )
    ...
    return [
        ...
        html.Div(style={
            ...
            html.Div('''
                ...
                on the columns.
            '''),
            html_table(df, table_style={}, cell_style={
                'paddingLeft': 10
            }),
            ...
            html.Div('Here, the min-width for the first column is 130px, or about the width of this line: '),
            html.Div(style={'width': 130, 'height': 10, 'backgroundColor': 'hotpink'}),
            html_table(
                df,
            ...
            '''),
            html.Div(style={'width': 50, 'height': 10, 'backgroundColor': 'hotpink'}),
            html_table(
                df,
                table_style={'width': '100%'},
                column_style={
            ...
            '''),
            html.Div(style={'width': 20, 'height': 10, 'backgroundColor': 'hotpink'}),
            html_table(
                df,
                table_style={'width': '100%'},
                column_style={
